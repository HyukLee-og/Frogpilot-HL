...
class CAR(StrEnum):
  ...
  TRAVERSE = "CHEVOLET TRAVERSE 2023"
...
CAR_INFO: Dict[str, Union[GMCarInfo, List[GMCarInfo]]] = {
  ...
  CAR.TRAVERSE: GMCarInfo("Chevolet TRAVERSE 2023", "ACC"),
}
...
CAMERA_ACC_CAR = {CAR.BOLT_EUV, CAR.SILVERADO, CAR.EQUINOX, CAR.TRAILBLAZER, CAR.TRAVERSE}
