...
QT_MOC_LITERAL(1, 22, 17), // "closeParentToggle"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 20), // "closeSubParentToggle"
QT_MOC_LITERAL(4, 62, 16), // "openParentToggle"
QT_MOC_LITERAL(5, 79, 19) // "openSubParentToggle"

    },
    "FrogPilotVisualsPanel\0closeParentToggle\0"
...
void FrogPilotVisualsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotVisualsPanel::closeParentToggle)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FrogPilotVisualsPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotVisualsPanel::closeSubParentToggle)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FrogPilotVisualsPanel::closeParentToggle()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FrogPilotVisualsPanel::closeSubParentToggle()
{
